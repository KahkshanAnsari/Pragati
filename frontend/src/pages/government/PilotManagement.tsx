                    ...
                    <div className="flex flex-col lg:flex-row justify-between gap-6">
                          ...
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              {pilot.status === 'completed' && (
                                  <span className="inline-flex items-center gap-1 text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-800 border border-blue-300">
                                ...
                                rating ? (
                                  <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-2.5 py-0.5 rounded-full bg-amber-50 text-amber-900 border border-amber-300">
                                    ...
                                    Evaluated (★ {rating.overall_rating}.0/5)
                                  </span>
                                ) : (
                                  <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-300">
                      ...
                      <div className="flex flex-col gap-2.5 lg:w-56 shrink-0 justify-center bg-gray-50 p-4 rounded-xl border border-gray-100">
                        {pilot.status === 'completed' && (
                          <Button
                            variant="secondary"
                            className="w-full text-xs font-bold text-blue-900 bg-blue-50 border-blue-300 hover:bg-blue-100 flex items-center justify-center gap-1.5 py-2 shadow-xs"
                            onClick={() => {
                              const projId = pilot.id === '0a000001-1111-4111-8111-000000000001'
                                ? 'gp000002-1111-4111-8111-000000000002'
                                : pilot.id === '0a000003-1111-4111-8111-000000000003'
                                ? 'gp000001-1111-4111-8111-000000000001'
                                : 'gp000003-1111-4111-8111-000000000003';
                              navigate(`/government/projects/${projId}`);
                            }}
                          >
                        ...
                        {pilot.status === 'completed' && (
                          rating ? (
                            <Button
                              variant="secondary"
                              className="w-full text-xs font-bold text-amber-900 bg-amber-50 border-amber-300 hover:bg-amber-100 flex items-center justify-center gap-1.5 py-2.5 shadow-xs"
                              onClick={() => navigate(`/government/pilots/${pilot.id}/evaluate`)}
                            >
                              <Star className="w-3.5 h-3.5 text-amber-500 fill-amber-500" />
                              View Evaluation (★ {rating.overall_rating}.0/5)
                            </Button>
                          ) : (
                            <Button
                              className="w-full bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold py-2.5 shadow-xs flex items-center justify-center gap-1.5"
                              onClick={() => navigate(`/government/pilots/${pilot.id}/evaluate`)}
                            >
