        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          {!isMatching &&
            matches.map((match, index) => {
              ...
              const perf = getStartupPerformanceSummary(st);
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {perf.averageRating > 0 && (
                              <span className="text-[10px] font-bold text-amber-900 bg-amber-50 px-2.5 py-0.5 rounded-full flex items-center gap-1 border border-amber-300">
                                <Star className="w-3 h-3 fill-amber-400 text-amber-500" /> Gov Performance: ★ {perf.averageRating.toFixed(1)}
                              </span>
                            )}
                          </div>
