            ...
            <Card className="p-6 border border-gray-200 shadow-xs">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 pb-3 border-b border-gray-100">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      <h3 className="text-lg font-bold text-navy-900 leading-tight">Government Performance Rating</h3>
                      {perf.hasEvaluations && (
                        <span className="text-[10px] font-bold text-emerald-800 bg-emerald-100 px-2 py-0.5 rounded-full border border-emerald-300 flex items-center gap-1">
                          <ShieldCheck className="w-3 h-3 text-emerald-600" /> Government Verified Performance
                        </span>
                      )}
                    </div>
              ...
              {perf.hasEvaluations && (
                <div className="mt-4 pt-3 border-t border-gray-100 space-y-2">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-gray-500 flex items-center gap-1.5">
                    <Award className="w-3.5 h-3.5 text-blue-600" /> Performance Breakdown by Criteria
                  </h4>
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-xs">
                    <div className="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                      <span className="block text-[10px] text-gray-500">Technical</span>
                      <p className="font-extrabold text-navy-900 mt-0.5">★ {perf.dimensionAverages.technical.toFixed(1)}/5</p>
                    </div>
                    <div className="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                      <span className="block text-[10px] text-gray-500">Effectiveness</span>
                      <p className="font-extrabold text-navy-900 mt-0.5">★ {perf.dimensionAverages.effectiveness.toFixed(1)}/5</p>
                    </div>
                    <div className="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                      <span className="block text-[10px] text-gray-500">Support</span>
                      <p className="font-extrabold text-navy-900 mt-0.5">★ {perf.dimensionAverages.implementation.toFixed(1)}/5</p>
                    </div>
                    <div className="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                      <span className="block text-[10px] text-gray-500">Timeliness</span>
                      <p className="font-extrabold text-navy-900 mt-0.5">★ {perf.dimensionAverages.timeliness.toFixed(1)}/5</p>
                    </div>
                    <div className="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                      <span className="block text-[10px] text-gray-500">KPI Delivery</span>
                      <p className="font-extrabold text-navy-900 mt-0.5">★ {perf.dimensionAverages.kpi.toFixed(1)}/5</p>
                    </div>
                  </div>
                </div>
              )}
